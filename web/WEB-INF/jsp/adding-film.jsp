				...
				<div class="box">
					<div class="border-right">
						<div class="border-left">
							<div class="inner">
								<h3>Добавление <span>фильма</span></h3>
								<form id="contacts-form" action="/Movies" method="post">
                                    <input type="hidden" name="command" value="add_new_film"/>
									<fieldset>
										<div class="field"><label>Название фильма:</label><input type="text" name="film_name" value=""/></div>
										<div class="field"><label>Жанр фильма:</label><input type="text" name="film_genre" value=""/></div>
										...
										<div class="field"><label>Имя режиссёра:</label><input type="text" name="director_name" value=""/></div>
										<div class="field"><label>Фамилия режиссёра:</label><input type="text" name="director_surname" value=""/></div>
										<div class="field"><label>Возрастной рейтинг:</label>
											<select name="rating" style="width: 100px; height: 20px">
												<c:forEach var="elem" items="${rating_list}" varStatus="status">
													<option value="${elem.filmRating}">${elem.filmRating}</option>
												</c:forEach>
											</select></div>
                                        <div class="field"><label>Бюджет фильма, $:</label><input type="number" name="budget" value="1000000"/></div>
                                        <div class="field"><label>Кассовые сборы, $:</label><input type="number" name="box_office" value="50000000"/></div>
                                        <div class="field"><label>Год выхода:</label><input type="number" name="film_year" value="2000"/></div><br />
                                        <div class="field"><label>Имя картинки:</label><input type="file" accept="image/*" name="film-image" value=""/></div>
                                        <div class="wrapper">
