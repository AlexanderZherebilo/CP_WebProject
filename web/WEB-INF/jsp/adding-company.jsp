				...
				<div class="box">
					<div class="border-right">
						<div class="border-left">
							<div class="inner">
								<h3>Добавление <span>компании</span></h3>
								<form id="contacts-form" action="/Movies" method="post">
                                    <input type="hidden" name="command" value="add_new_company"/>
									<fieldset>
										<div class="field"><label>Название компании:</label><input type="text" name="company_name" value="" required/></div>
										<div class="field"><label>Год основания:</label><input type="number" name="founding_year" value="" required/></div>
										<div class="field"><label>Страна:</label><input type="text" name="company_country" value="" required/></div>
										<div class="field"><label>Имя основателя:</label><input type="text" name="founder_name" value="" required/></div>
										<div class="field"><label>Фамилия основателя:</label><input type="text" name="founder_surname" value="" required/></div>
										<div class="field"><label>Имя главы компании:</label><input type="text" name="head_name" value=""/></div>
										<div class="field"><label>Фамилия главы компании:</label><input type="text" name="head_surname" value=""/></div>
										<div class="field"><label>Веб-сайт (после "www."):</label><input type="text" name="site" value=""/></div>
                                        <div class="field"><label>Имя картинки:</label><input type="file" accept="image/*" name="company-image" value=""/></div>
                                        <div class="wrapper">
											...
											<button style="width: 130px; height: 30px; float: right; font-size: 14px; color: white; background-color: #1d1d1d"
													...
													onmouseout="this.style.backgroundColor='#1d1d1d'; this.style.color='white'" type="submit">Добавить
											</button>
										</div>
									</fieldset>
								</form>
